...
fs.readdir('./komutlar/', (err, files) => {
    ...
    log(`${files.length} komut yüklenecek. Phentos Tarafından Hazırlandı!`);
    files.forEach(f => {
...
client.on("guildMemberAdd", phentos => {
    ...
    phentos.setNickname(`${tag} İsim | Yaş`)
      ...
      phentos.roles.add("kayıtsızrolid");
    })
    //Sunucuya giriş mesajı
    ...
    const phentosfoto = new Discord.MessageAttachment("https://cdn.discordapp.com/attachments/779455383986241536/798281651342934036/1.gif");
    channel.send(`
